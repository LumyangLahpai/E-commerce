...
public interface feedbackLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>feedbackA5.service.impl.feedbackLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the feedback local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link feedbackLocalServiceUtil} if injection and service tracking are not available.
	 */
